...
public class StarManagerEarthquake3 : MonoBehaviour
{
    public static StarManagerEarthquake3 Instance;
    ...
    public GameObject timerUI; // optional (if separate container)
    ...
    void Start()
    {
        ...
        // Hide gameplay UI at start (intro phase)
        if (radialMenu) radialMenu.SetActive(false);
    ...
    public void StartGameplay()
    {
        ...
        if (radialMenu) radialMenu.SetActive(true);
    ...
    void Update()
    {
        if (levelEnded || !gameplayStarted) return;
